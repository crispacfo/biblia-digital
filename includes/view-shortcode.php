...
<div class="<?php echo esc_attr( $bdwp70_root_class ); ?>" data-bdwp70>
	...
	<?php if ( 'books' === $state['mode'] ) : ?>
		<section class="bdwp70__home-hero bdwp70__home-hero--brand" aria-labelledby="bdwp70-home-title">
			...
			<div class="bdwp70__home-hero-content">
				<div class="bdwp70__hero-brand">
					<img src="<?php echo esc_url( $bdwp70_hero_logo_url ); ?>" alt="<?php echo esc_attr__( 'Estudo Bíblico', 'biblia-digital' ); ?>" loading="lazy">
				</div>
				<span class="bdwp70__hero-eyebrow"><?php esc_html_e( '✥ A Palavra que transforma ✥', 'biblia-digital' ); ?></span>
				<h1 id="bdwp70-home-title" class="bdwp70__hero-title"><?php echo esc_html( $atts['title'] ); ?></h1>
				<p><?php esc_html_e( 'Leia, estude e medite na Palavra de Deus onde estiver. Acesso gratuito e completo à Bíblia Sagrada.', 'biblia-digital' ); ?></p>
				<div class="bdwp70__hero-actions">
					<a class="bdwp70__hero-button" href="#bdwp70-livros"><?php esc_html_e( '📖 Ler agora', 'biblia-digital' ); ?></a>
				</div>
		...
		<section class="bdwp70__books-home" id="bdwp70-livros" aria-labelledby="bdwp70-books-title">
			<div class="bdwp70__books-headline">
				<div>
					<h2 id="bdwp70-books-title"><?php esc_html_e( 'Bíblia Digital Online', 'biblia-digital' ); ?></h2>
					<p><?php esc_html_e( 'Acesse todos os livros da Bíblia Sagrada de forma rápida e organizada.', 'biblia-digital' ); ?></p>
				</div>
			</div>

			<?php if ( ! empty( $bdwp70_quick_cards ) ) : ?>
				<div class="bdwp70__quick-cards" id="bdwp70-como-usar" aria-label="<?php esc_attr_e( 'Acessos rápidos da Bíblia Digital', 'biblia-digital' ); ?>">
			...
			<div class="bdwp70__testaments bdwp70__testaments--cards">
				<section class="bdwp70__testament-card" aria-labelledby="bdwp70-old-testament">
					<header class="bdwp70__testament-header">
						...
						<h2 id="bdwp70-old-testament"><?php esc_html_e( 'Antigo Testamento', 'biblia-digital' ); ?></h2>
						<a href="#bdwp70-old-testament"><?php esc_html_e( 'Ver todos', 'biblia-digital' ); ?></a>
					</header>
				...
				<section class="bdwp70__testament-card" aria-labelledby="bdwp70-new-testament">
					<header class="bdwp70__testament-header">
						<span class="bdwp70__testament-icon" aria-hidden="true">✝</span>
						<h2 id="bdwp70-new-testament"><?php esc_html_e( 'Novo Testamento', 'biblia-digital' ); ?></h2>
						<a href="#bdwp70-new-testament"><?php esc_html_e( 'Ver todos', 'biblia-digital' ); ?></a>
					</header>
		...
		<div class="bdwp70__books-version-panel" id="bdwp70-versao-biblia" aria-label="<?php esc_attr_e( 'Escolha da tradução da Bíblia', 'biblia-digital' ); ?>">
			<span class="bdwp70__books-version-panel-text"><?php esc_html_e( 'Escolha a tradução da Bíblia para continuar a leitura nesta versão:', 'biblia-digital' ); ?></span>
	...
	<?php elseif ( 'book' === $state['mode'] && $bdwp70_selected_book_name ) : ?>
		<div class="bdwp70__book-page">
			...
			<p><?php esc_html_e( 'Selecione o capítulo que deseja ler.', 'biblia-digital' ); ?></p>
			...
			<p><a class="bdwp70__clear" href="<?php echo esc_url( $bdwp70_current_url ); ?>"><?php esc_html_e( 'Voltar aos livros', 'biblia-digital' ); ?></a></p>
		</div>
	<?php endif; ?>
			...
			<div class="bdwp70__reader-layout bdwp70__reader-layout--single">
				<article class="bdwp70__reader-main">
					<header class="bdwp70__chapter-heading">
						...
						<nav class="bdwp70__chapter-nav bdwp70__chapter-nav--top" aria-label="<?php esc_attr_e( 'Navegação entre capítulos', 'biblia-digital' ); ?>">
							<?php
							if ( $bdwp70_previous_chapter_url ) :
								?>
								<a href="<?php echo esc_url( $bdwp70_previous_chapter_url ); ?>"><?php esc_html_e( '← Capítulo anterior', 'biblia-digital' ); ?></a><?php endif; ?>
							...
							if ( $bdwp70_next_chapter_url ) :
								?>
								<a href="<?php echo esc_url( $bdwp70_next_chapter_url ); ?>"><?php esc_html_e( 'Próximo capítulo →', 'biblia-digital' ); ?></a><?php endif; ?>
						</nav>
						<?php $bdwp70_reading_options_id = 'bdwp70-reading-options-' . (int) $state['book'] . '-' . (int) $state['chapter']; ?>
						<div class="bdwp70__reading-tools bdwp70__reading-panel" aria-label="<?php esc_attr_e( 'Ajustes de leitura', 'biblia-digital' ); ?>">
							...
							<div id="<?php echo esc_attr( $bdwp70_reading_options_id ); ?>" class="bdwp70__reading-options" data-bdwp70-panel hidden>
								<header class="bdwp70__reading-options-head">
									...
									<strong><?php esc_html_e( 'Opções de leitura', 'biblia-digital' ); ?></strong>
								</header>

								<section class="bdwp70__reading-option-group" aria-labelledby="bdwp70-font-size-label">
									<span id="bdwp70-font-size-label" class="bdwp70__reading-option-label"><?php esc_html_e( 'Tamanho da fonte', 'biblia-digital' ); ?></span>
									<div class="bdwp70__reading-size-row">
										<button type="button" class="bdwp70__reading-round" data-bdwp70-font="decrease" aria-label="<?php esc_attr_e( 'Diminuir tamanho da fonte', 'biblia-digital' ); ?>">A−</button>
										<span class="bdwp70__reading-size-status" data-bdwp70-font-label><strong>Aa</strong><small><?php esc_html_e( 'Médio', 'biblia-digital' ); ?></small></span>
										<button type="button" class="bdwp70__reading-round" data-bdwp70-font="increase" aria-label="<?php esc_attr_e( 'Aumentar tamanho da fonte', 'biblia-digital' ); ?>">A+</button>
									</div>
								</section>

								<section class="bdwp70__reading-option-group" aria-labelledby="bdwp70-format-label">
									<span id="bdwp70-format-label" class="bdwp70__reading-option-label"><?php esc_html_e( 'Formato do texto', 'biblia-digital' ); ?></span>
									<div class="bdwp70__reading-choice-grid" role="group" aria-label="<?php esc_attr_e( 'Formato do texto bíblico', 'biblia-digital' ); ?>">
										<button type="button" data-bdwp70-format="verse" class="is-active"><span aria-hidden="true">☷</span><?php esc_html_e( 'Versículo', 'biblia-digital' ); ?></button>
										<button type="button" data-bdwp70-format="continuous"><span aria-hidden="true">☰</span><?php esc_html_e( 'Corrido', 'biblia-digital' ); ?></button>
									</div>
								</section>

								<section class="bdwp70__reading-option-group" aria-labelledby="bdwp70-font-family-label">
									<span id="bdwp70-font-family-label" class="bdwp70__reading-option-label"><?php esc_html_e( 'Fonte para leitura', 'biblia-digital' ); ?></span>
									<div class="bdwp70__reading-choice-grid" role="group" aria-label="<?php esc_attr_e( 'Fonte para leitura bíblica', 'biblia-digital' ); ?>">
										<button type="button" data-bdwp70-font-family="default" class="is-active"><strong>Aa</strong><?php esc_html_e( 'Padrão', 'biblia-digital' ); ?></button>
										<button type="button" data-bdwp70-font-family="lexend"><strong>Aa</strong><?php esc_html_e( 'Lexend', 'biblia-digital' ); ?></button>
									</div>
								</section>

								<section class="bdwp70__reading-option-group" aria-labelledby="bdwp70-bg-label">
									<span id="bdwp70-bg-label" class="bdwp70__reading-option-label"><?php esc_html_e( 'Fundo de leitura', 'biblia-digital' ); ?></span>
									<div class="bdwp70__reading-bg-row" role="group" aria-label="<?php esc_attr_e( 'Cor de fundo da leitura', 'biblia-digital' ); ?>">
										<button type="button" data-bdwp70-bg="light"><?php esc_html_e( 'Claro', 'biblia-digital' ); ?></button>
										<button type="button" data-bdwp70-bg="sepia"><?php esc_html_e( 'Sépia', 'biblia-digital' ); ?></button>
										<button type="button" data-bdwp70-bg="soft"><?php esc_html_e( 'Suave', 'biblia-digital' ); ?></button>
										<button type="button" data-bdwp70-bg="dark"><?php esc_html_e( 'Escuro', 'biblia-digital' ); ?></button>
									</div>
								</section>
							</div>
						</div>
					...
					<nav class="bdwp70__chapter-nav bdwp70__chapter-nav--bottom" aria-label="<?php esc_attr_e( 'Navegação entre capítulos no rodapé', 'biblia-digital' ); ?>">
						<?php
						if ( $bdwp70_previous_chapter_url ) :
							?>
							<a href="<?php echo esc_url( $bdwp70_previous_chapter_url ); ?>"><?php esc_html_e( '← Capítulo anterior', 'biblia-digital' ); ?></a><?php endif; ?>
						<a href="<?php echo esc_url( $this->maybe_add_bible_version_arg_to_url( home_url( user_trailingslashit( $this->seo_base() . '/' . $this->book_slug_from_seq( $bdwp70_selected_book, $bdwp70_books ) ) ), (int) $state['bible_id'] ) ); ?>"><?php /* translators: %s: Bible book name. */ echo esc_html( sprintf( __( 'Capítulos de %s', 'biblia-digital' ), $bdwp70_selected_book_name ) ); ?></a>
						<?php
						if ( $bdwp70_next_chapter_url ) :
							?>
							<a href="<?php echo esc_url( $bdwp70_next_chapter_url ); ?>"><?php esc_html_e( 'Próximo capítulo →', 'biblia-digital' ); ?></a><?php endif; ?>
	...
	<?php if ( (int) $results['total_pages'] > 1 ) : ?>
		<nav class="bdwp70__pagination" aria-label="<?php esc_attr_e( 'Paginação da Bíblia Digital', 'biblia-digital' ); ?>">
			<?php
	...
	<?php if ( class_exists( 'BDWP70_Plugin' ) && (int) get_option( BDWP70_Plugin::OPTION_CREDIT, 0 ) ) : ?>
		<div class="bdwp70__footer">
			<?php echo wp_kses_post( __( 'Bíblia Digital Online por <a href="https://estudobiblico.org/" target="_blank" rel="noopener noreferrer">Estudo Bíblico</a>.', 'biblia-digital' ) ); ?>
		</div>
	<?php endif; ?>
</div>
